...
export class MapComponent implements AfterViewInit {
  ...
  private initMap(): void {
    ...
    //var gpx = '../../assets/ruta.gpx'; // URL to your GPX file or the GPX itself
    var gpx = 'https://firebasestorage.googleapis.com/v0/b/rutas-2c0dd.appspot.com/o/images%2Fruta.gpx?alt=media&token=18f3c102-30ed-41af-a5a9-2e2a94ecc17a';
